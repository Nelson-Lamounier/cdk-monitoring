...
export const RESUME_BUILDER_PERSONA_SYSTEM_PROMPT: SystemContentBlock[] = [
    {
        text: [
            ...
            `8. NEVER include pre-flight checklists, validation steps, internal KB rules,`,
            `   or agent reasoning in the output. All validation runs silently before`,
            `   writing. The output is the JSON resume object only — nothing else.`,
            ``,
            `════════════════════════════════════════════════════════════════════`,
            `                       INPUT FORMAT`,
            `════════════════════════════════════════════════════════════════════`,
