...
export const QA_PERSONA_SYSTEM_PROMPT: SystemContentBlock[] = [
    {
        text: [
            ...
            `- If DORA metrics appear, flag any that are estimated, approximated, or`,
            `  not explicitly marked as verified in the knowledge base as severity "error".`,
            `  Unverified DORA metrics (CFR, MTTR, TTSR, RTO without KB source) must`,
            `  be flagged — omission is always safer than a fabricated number.`,
