...
/**
 * Props for the Bootstrap Alarm construct.
 */
...
/**
 * Bootstrap failure alarm — CloudWatch alarm + SNS notification.
 *
 * Monitors Step Functions execution failures and sends email
 * notifications when bootstrap failures are detected.
 */
