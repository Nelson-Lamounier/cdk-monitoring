 ...
 *
 * Original purpose: CloudFront CDN + WAF + ACM for nelsonlamounier.com (kubeadm Traefik → EIP origin, us-east-1).
 * Why deprecated:
 *   - ALB (EksAlbCertsStack) is now the sole public endpoint — no CDN layer
 *   - ExternalDNS owns all DNS records for nelsonlamounier.com
 ...
 *
 * @destroyOrder
 *   1. Ensure ExternalDNS has taken ownership of nelsonlamounier.com Route53 records
 *   2. cdk destroy k8s-Edge-development --region us-east-1
 *
 ...
 */
export class Deprecated_KubernetesEdgeStack extends cdk.Stack {
    // ACM Certificate
