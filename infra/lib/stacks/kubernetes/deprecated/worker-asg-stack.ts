 ...
 *
 *   - `general`:    t3.small Spot, min=1/max=4. Hosts Next.js, tucaken-app, admin-api,
 ...
 *
 * - `general`:    Hosts Next.js, tucaken-app, admin-api, public-api, wiki-mcp, system components.
