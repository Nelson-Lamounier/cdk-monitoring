/**
 * @deprecated Replaced by EksAlbCertsStack + EksPublicWafStack + ExternalDNS on 2026-05-06.
 * @see docs/superpowers/specs/2026-05-05-eks-migration-design.md
 *
 * Original purpose: CloudFront CDN + WAF + ACM for tucaken.io / tucaken.com (kubeadm Traefik → EIP origin, us-east-1).
 * Why deprecated:
 *   - ALB (EksAlbCertsStack) is now the sole public endpoint — no CDN layer
 *   - ExternalDNS owns all DNS records for tucaken.io and tucaken.com
 *   - ACM wildcard certs live in EksAlbCertsStack
 *   - WAF moved to EksPublicWafStack (REGIONAL scope, ALB-attached)
 * Why kept: Reference implementation. Do not delete.
 *
 * @destroyOrder
 *   1. Ensure ExternalDNS has taken ownership of tucaken.io / tucaken.com Route53 records
 *   2. cdk destroy k8s-TucakenEdge-development --region us-east-1
 *
...
export class Deprecated_TucakenEdgeStack extends cdk.Stack {
