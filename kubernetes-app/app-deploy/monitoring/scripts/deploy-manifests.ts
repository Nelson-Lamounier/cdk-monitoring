 ...
 *
 * Usage:
 *   npx tsx kubernetes-app/app-deploy/monitoring/scripts/deploy-manifests.ts kubernetes development
 *   npx tsx kubernetes-app/app-deploy/monitoring/scripts/deploy-manifests.ts kubernetes production --region eu-west-1
 *
 * Environment:
